...
const div_new = DocumentTimeline.createdElement('div');
div_new.innerHTML = `
<div class="row">
<div class="column">
    <div class="card">
    ...
    <input type= "text" id="nre_user" value=""></input>
    </p>
...
function returnMovies(url) {
    ...
    .then(function(data) {
        ...
        data.foreach(element => {
            const div_card = document.createdElement('div');
            div_card.innerHtml = `
            <div class="row">
    <div class="column">
...
` 
    ...
    function editReview(IdleDeadline, review, user) {
